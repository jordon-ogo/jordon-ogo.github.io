 ...
 * @default
 *
 * @param Change Timer Length Background
 * @desc The background used for the item menu screen.
 * Place it in img/SumRndmDde/menu/
 * @default
 *
 * @param Change Timer Length Opacity
 * @desc The opacity of the windows in the item menu screen.
 * Set to a number between 0 and 255
 * @default 255
 *
 * @param Change Timer Length Scale
 * @desc The base scale of the background image.
 * 1 is a normal scale; 0.5 is half; 2 is double; etc...
 * @default 1
 *
 * @param Change Timer Length Motion
 * @desc The motion of the background image.
 * Visit the HELP section for a list of motions.
 * @default
 *
 ...
 * @default
 *
 * @param Restart Level Background
 * @desc The background used for the skill menu screen.
 * Place it in img/SumRndmDde/menu/
 * @default
 *
 * @param Restart Level Opacity
 * @desc The opacity of the windows in the skill menu screen.
 * Set to a number between 0 and 255
 * @default 255
 *
 * @param Restart Level Scale
 * @desc The base scale of the background image.
 * 1 is a normal scale; 0.5 is half; 2 is double; etc...
 * @default 1
 *
 * @param Restart Level Motion
 * @desc The motion of the background image.
 * Visit the HELP section for a list of motions.
 * @default
 *
 ...
 * @default
 *
 * @param Return To Main Menu Background
 * @desc The background used for the equip menu screen.
 * Place it in img/SumRndmDde/menu/
 * @default
 *
 * @param Return To Main Menu Opacity
 * @desc The opacity of the windows in the equip menu screen.
 * Set to a number between 0 and 255
 * @default 255
 *
 * @param Return To Main Menu Scale
 * @desc The base scale of the background image.
 * 1 is a normal scale; 0.5 is half; 2 is double; etc...
 * @default 1
 *
 * @param Return To Main Menu Motion
 * @desc The motion of the background image.
 * Visit the HELP section for a list of motions.
 * @default
 *
...
_.backgrounds = {};
// Scene_CustomMenu is the custom pause menu
_.backgrounds["Scene_CustomMenu"] = String(params['Main Pause Menu Background']);
_.backgrounds["Change_Timer_Length_Menu"] = String(params['Change Timer Length Background']);
_.backgrounds["Restart_Yes_No_Menu"] = String(params['Restart Level Background']);
_.backgrounds["MainMenu_Yes_No_Menu"] = String(params['Return To Main Menu Background']);
_.backgrounds["Accessibility_Menu"] = String(params['Status Background']);
_.backgrounds["Change_Hearts_Amount_Menu"] = String(params['Save Background']);
_.backgrounds["Hearts_Refresh_Yes_No_Menu"] = String(params['Options Background']);
_.backgrounds["Scene_GameEnd"] = String(params['End Background']);

_.opacity = {};
_.opacity["Scene_CustomMenu"] = parseInt(params['Main Pause Menu Opacity']);
_.opacity["Change_Timer_Length_Menu"] = parseInt(params['Change Timer Length Opacity']);
_.opacity["Restart_Yes_No_Menu"] = parseInt(params['Restart Level Opacity']);
_.opacity["MainMenu_Yes_No_Menu"] = parseInt(params['Return To Main Menu Opacity']);
_.opacity["Accessibility_Menu"] = parseInt(params['Status Opacity']);
_.opacity["Change_Hearts_Amount_Menu"] = parseInt(params['Save Opacity']);
_.opacity["Hearts_Refresh_Yes_No_Menu"] = parseInt(params['Options Opacity']);
_.opacity["Scene_GameEnd"] = parseInt(params['End Opacity']);

_.scales = {};
_.scales["Scene_CustomMenu"] = parseFloat(params['Main Pause Menu Scale']);
_.scales["Change_Timer_Length_Menu"] = parseFloat(params['Change Timer Length Scale']);
_.scales["Restart_Yes_No_Menu"] = parseFloat(params['Restart Level Scale']);
_.scales["MainMenu_Yes_No_Menu"] = parseFloat(params['Return To Main Menu Scale']);
_.scales["Accessibility_Menu"] = parseFloat(params['Status Scale']);
_.scales["Change_Hearts_Amount_Menu"] = parseFloat(params['Save Scale']);
_.scales["Hearts_Refresh_Yes_No_Menu"] = parseFloat(params['Options Scale']);
_.scales["Scene_GameEnd"] = parseFloat(params['End Scale']);

_.motions = {};
_.motions["Scene_CustomMenu"] = String(params['Main Pause Menu Motion']);
_.motions["Change_Timer_Length_Menu"] = String(params['Change Timer Length Motion']);
_.motions["Restart_Yes_No_Menu"] = String(params['Restart Level Motion']);
_.motions["MainMenu_Yes_No_Menu"] = String(params['Return To Main Menu Motion']);
_.motions["Accessibility_Menu"] = String(params['Status Motion']);
_.motions["Change_Hearts_Amount_Menu"] = String(params['Save Motion']);
_.motions["Hearts_Refresh_Yes_No_Menu"] = String(params['Options Motion']);
