...
{  
  ...
  displayOverlayTile = function( args )
  {
    ...
    allTileChangeLocations[[x, y]] = true;
  ...
  {
    if (allTileChangeLocations[args] != true){
      return;
    }
    delete allTileChangeLocations[args];
    var testX = args[ 0 ];
    var testY = args[ 1 ];
  ...
  /*removeAllTiles = function(args){

    for (var pos in allTileChangeLocations){
      console.log("Removing tile at pos: " + String(pos));
      removeTile(pos);
    }
