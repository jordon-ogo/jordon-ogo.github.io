...
(function() {
    ...
    BMM.PT.BOSS_Spectre = class extends Boss {
        constructor(event) {
            ...
            BMM.PT.spectreBlurStrength = new BMM.TIME.easeOut(BMM.PT.spectreBlurStrengthMax, 0, 2, 2000);
        ...
        reappear() {
            ...
            BMM.PT.spectreBlurStrength = new BMM.TIME.easeOut(BMM.PT.spectreBlurStrengthMax, 0, 2, 3000);
        }
        damage(amount) {
