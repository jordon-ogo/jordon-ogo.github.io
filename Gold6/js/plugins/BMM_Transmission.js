    ...
    class LevelMap {
        ...
        isOpen(x, y) { // TODO: Improve this
            if (x >= 0 && y >= 0 && x < this.width && y < this.height) {
                ...
                if ((e != null && e.type != "warning") || (BMM.TIME.dashInterp != null && BMM.TIME.playerEffectivePosition[0] == x && BMM.TIME.playerEffectivePosition[1] == y) || ($gamePlayer.x == x && $gamePlayer.y == y)) {
                    return false;
                } else {
                    return true;
                }
