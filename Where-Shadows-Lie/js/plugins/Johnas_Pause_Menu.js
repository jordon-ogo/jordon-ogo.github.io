...
Scene_CustomMenu.prototype.create = function() 
{
    ...
    this._customSelectableWindow = new Window_CustomSelectable( 0, 275, 180, 180 );
    ...
    this._customCommandWindow = new Window_CustomCommand( 0, 275 );
    ...
    this._customHorzCommandWindow = new Window_CustomHorzCommand( 0, 275 );
